<?php
 ...
 $dbname 	= isset($_POST["dbname"])?$_POST["dbname"]:"dbstatistik";
 $site_title 	= isset($_POST["site_title"])?$_POST["site_title"]:"Sistem Pendataan Penduduk";
 $menu_title 	= isset($_POST["menu_title"])?$_POST["menu_title"]:"Sistem Pendataan Penduduk";
...
if (isset($_POST["idb"])) {
   ...
   if (!$errors) {
    populate_db($connect_id,'dbstatistik.sql');
    if (!$errors) $step=2;
