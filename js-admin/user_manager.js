valid_script =true; 
ajax_url = 'ajax.admin.php?id=' + mypage;
var first_time  = true; 
var proxyUser = new Ext.data.HttpProxy({
			api : {
				read : ajax_url + '&task=gridUser&action=doRead',
				create : ajax_url + '&task=gridUser&action=doCreate',
				update : ajax_url + '&task=gridUser&action=doUpdate',
				destroy : ajax_url + '&task=gridUser&action=doDestroy'
			}
		});
...
var proxyGroup = new Ext.data.HttpProxy({
			api : {
				read : ajax_url + '&task=gridGroup&action=doRead',
				create : ajax_url + '&task=gridGroup&action=doCreate',
				update : ajax_url + '&task=gridGroup&action=doUpdate',
				destroy : ajax_url + '&task=gridGroup&action=doDestroy'
			}
		});
...
var proxyEvent = new Ext.data.HttpProxy({
			api : {
				read : ajax_url + '&task=gridEvent&action=doRead',
				create : ajax_url + '&task=gridEvent&action=doCreate',
				update : ajax_url + '&task=gridEvent&action=doUpdate',
				destroy : ajax_url + '&task=gridEvent&action=doDestroy'
			}
		});
