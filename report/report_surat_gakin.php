...
$pdf->ezSetDy(-20);
$pdf->ezText('<u><b>SURAT KETERANGAN KELUARGA MISKIN</b></u>',16,Array('justification'=>'center'));
$pdf->ezSetDy(-8);
...
$data = Array(
                ...
                Array('name'=>'Untuk Keperluan','sep'=>':','value'=>$rs->fields['keterangan_1']),
                Array('name'=>'','sep'=>'','value'=>'dengan memakai fasilitas Askes Gakin')
        );
