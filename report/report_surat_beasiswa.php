...
$template_file = "template_word/s_beasiswa.doc";
$download_file ="download_word/surat_beasiswa.doc";

$PHPWord = new PHPWord();
$document = $PHPWord->loadTemplate($template_file);
$document->setValue('nomor','420/'.$rs->fields['no_surat'].'/421.621.010/'.getYear($rs->fields['tgl_ttd']));
